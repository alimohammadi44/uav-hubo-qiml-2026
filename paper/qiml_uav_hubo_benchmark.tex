...
The code package for this revision includes the HUBO builder, A* baseline, RRT/QUAV-style baseline, trajectory-SA, \texttt{neal} benchmark, exact CP-SAT baseline, companion MILP model, plotting scripts, and result logs. The code and supplementary materials are available through the project repository~\cite{mohammadiGithub}: \url{https://github.com/alimohammadi44/uav-hubo-qiml-2026/tree/main}.
...
\bibitem{mohammadiGithub} A. Mohammadi, ``UAV HUBO/QUBO benchmark code and supplementary materials,'' GitHub, 2026. [Online]. Available: \url{https://github.com/alimohammadi44/uav-hubo-qiml-2026/tree/main}.
\end{thebibliography}

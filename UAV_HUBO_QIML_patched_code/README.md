...
## Conference-paper reproducibility notes

The v3.2 benchmark records structural feasibility, goal arrival, full-task success, visibility rate, and decoded trajectories for each stochastic sample. QAOA is treated as a tiny compatibility check, not as evidence that QAOA solves the full 8x8 HUBO.
